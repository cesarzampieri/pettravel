  ...
  const testimonials = [
    {
      ...
      text: "Confiei meu querido Max à PetTravel e não me arrependo. Ele chegou em Miami seguro, feliz e bem cuidado. Excelente atendimento!",
      rating: 5,
    },
    {
      name: "João Santos",
    ...
    },
    {
      ...
      text: "Serviço de transporte terrestre impecável. Meu cachorro chegou feliz e descansado. Recomendo muito a PetTravel!",
      rating: 5,
    },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-foreground/70 text-lg max-w-2xl mx-auto">
            Veja o que nossos clientes dizem sobre a experiência com a PetTravel.
          </p>
        </div>
